...
LAYOUT_SCHEMA: _Schema = {
    ...
    LayoutKeys.DASHBOARD: SchemaField(
        type=str,
        env="LAYOUT_DASHBOARD",
        toml=f"{LayoutKeys.LAYOUT.value}.{LayoutKeys.DASHBOARD.value}",
        default=LayoutDefaults.DASHBOARD.value,
        help_text=LayoutHelpTexts.DASHBOARD.value,
    ),
}
...
SECURITY_SCHEMA: _Schema = {
    ...
    SecurityKeys.ALWAYS_SHOW_ADMIN_OPTION: SchemaField(
        type=bool,
        env="ALWAYS_SHOW_ADMIN_OPTION",
        toml=SecurityKeys.ALWAYS_SHOW_ADMIN_OPTION.value,
        default=SecurityDefaults.ALWAYS_SHOW_ADMIN_OPTION.value,
        options=list(SecurityAlwaysShowAdminOptions),
        help_text=SecurityHelpTexts.ALWAYS_SHOW_ADMIN_OPTION.value,
    ),
}
