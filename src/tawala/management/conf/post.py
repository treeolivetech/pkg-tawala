...
from .. import DatabaseOptions, PresetOptions
from .pre import (
    BASE_CONF,
    DATABASES_CONF,
...
ROOT_URLCONF = f"{PKG_NAME}.apps.core.urls"
...
INSTALLED_APPS = (
    ...
    + [
        MAIN_APP,
        f"{PKG_NAME}.apps.work_in_progress",
        f"{PKG_NAME}.apps.core",
        PKG_NAME,
    ]
    + [
...
def get_storages_config(preset_backend_choice: str) -> _StoragesDict:
    ...
    match preset_backend_choice:
        ...
        case PresetOptions.VERCEL:
            storage_backend = f"{PKG_NAME}.management.backends.VercelBlobStorageBackend"
        case _:
