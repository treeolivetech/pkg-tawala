...
class _FetchProject:
    ...
    def __init__(self) -> None:
        ...
        self.core_app = "treeolive"
        self.core_name: Final[str] = self.core_app
        self.core_display_name: Final[str] = self.core_name.capitalize()
        self.core_version: Final[str] = Version.get(self.core_name)[0]
    ...
    def _load_project(self) -> None:
        ...
        if self.core_name not in tool_section:
            raise KeyError(f"Missing 'tool.{self.core_name}' section in pyproject.toml")
        self._base_toml = tool_section[self.core_name]
