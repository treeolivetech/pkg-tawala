...
class Command(BaseCommand):
    ...
    help = (
        ...
        "Usage:\n"
        f"  {settings.CORE_NAME} seed path/to/fixtures\n"
        f"  {settings.CORE_NAME} seed --app_label=myapp\n"
        f"  {settings.CORE_NAME} seed\n"
        f"  {settings.CORE_NAME} seed --verbose\n"
        f"  {settings.CORE_NAME} seed --app_label=myapp --extension=yaml\n\n"
        "Notes:\n"
